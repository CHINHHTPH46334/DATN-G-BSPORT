...
<div class="container mt-4">
    <h2 class="text-center mb-3">Cập nhật khách hàng</h2>

    <c:if test="${not empty error}">
        <div class="alert alert-danger">${error}</div>
    </c:if>

    <form action="/admin/khach-hang/update" method="post" class="row g-3">
        <input type="hidden" name="idKhachHang" value="${khachHang.idKhachHang}">
        <div class="col-md-6 form-group">
            <label class="form-label">Mã KH:</label>
            <input type="text" name="maKhachHang" class="form-control" value="${khachHang.maKhachHang}" readonly>
        </div>
        <div class="col-md-6 form-group">
        ...
        <div class="col-md-6 form-group">
            ...
            <input type="date" name="ngaySinh" class="form-control" value="${ngaySinhFormatted}">
        ...
        <div class="col-md-6 form-group">
            ...
            <textarea name="diaChi" class="form-control" rows="3">${diaChi}</textarea>
