...
//        List<HoaDonResponse> topSanPhamBanChay();
    ...
    @Query(nativeQuery = true, value = """
            select ctsp.id_chi_tiet_san_pham ,sp.ma_san_pham, (sp.ten_san_pham+N': Màu: '+ms.ten_mau_sac+N', size: '+kt.gia_tri) as ten_san_pham, ctsp.so_luong, ctsp.gia_ban from san_pham sp
