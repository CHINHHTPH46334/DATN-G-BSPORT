    ...
    public static ByteArrayInputStream sanPhamToExcel(List<ChiTietSanPhamView> list) {
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            for (ChiTietSanPhamView chiTiet : list) {
                ...
                row.createCell(3).setCellValue(chiTiet.getGia_ban());
                row.createCell(4).setCellValue(chiTiet.getNgay_tao().toString());
                row.createCell(5).setCellValue(chiTiet.getNgay_sua().toString());
                row.createCell(6).setCellValue(chiTiet.getSo_luong());
                row.createCell(7).setCellValue(chiTiet.getTrang_thai());
                row.createCell(8).setCellValue(chiTiet.getGia_tri());
                row.createCell(9).setCellValue(chiTiet.getDon_vi());
                row.createCell(10).setCellValue(chiTiet.getTen_chat_lieu());
                row.createCell(11).setCellValue(chiTiet.getTen_danh_muc());
                row.createCell(12).setCellValue(chiTiet.getTen_thuong_hieu());
                row.createCell(13).setCellValue(chiTiet.getTen_mau());
            }
